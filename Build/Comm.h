...
public:
    ...
    bool doNLineQuery( T_sglx_get_strs &cli_vs, t_sglxconn *S, const string &cmd ) noexcept(false);

    bool sendString( t_sglxconn *S, const string &s ) noexcept(false);
    bool read_1s_srvside( string &s, t_sglxconn *S ) noexcept(false);
    bool read_resp( string &resp, t_sglxconn *S, bool srvside ) noexcept(false);
    bool read_client_vs( T_sglx_get_strs &vs, t_sglxconn *S ) noexcept(false);
