...
//
        [DllImport("SglxApi.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        public static extern int c_sglx_ni_wave_arm(IntPtr hSglx, [MarshalAs(UnmanagedType.LPStr)] string outChan, [MarshalAs(UnmanagedType.LPStr)] string trigTerm);
...
//
        [DllImport("SglxApi.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        public static extern int c_sglx_ni_wave_load(IntPtr hSglx, [MarshalAs(UnmanagedType.LPStr)] string outChan, [MarshalAs(UnmanagedType.LPStr)] string wave, int loop);
